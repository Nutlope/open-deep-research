...
<div className="absolute bottom-2.5 left-2.5 flex justify-start items-center gap-2 p-1 rounded-md bg-white border border-gray-200">
        ...
        <div className="absolute bottom-2.5 right-12 flex flex-row gap-2">
          <Select value={selectedModel} onValueChange={setSelectedModel}>
            <SelectTrigger className="w-[100px] h-[26px] text-xs">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="Qwen/Qwen3-235B-A22B-Instruct-2507-tput">Qwen3 235B</SelectItem>
              <SelectItem value="zai-org/GLM-4.7">GLM 4.7</SelectItem>
              <SelectItem value="moonshotai/Kimi-K2-Instruct">Kimi K2</SelectItem>
            </SelectContent>
          </Select>
        </div>
